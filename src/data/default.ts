...
["Denim", "Faux fur", "Fur", "Lace", "Latex", "Leather", "Pleather", "Satin", "Silk", "Velvet", "Vinyl"], defaultRating),
    createKinkCategory("Affectionate", ["General"], 
["Romance", "Affection", "Kissing", "Cuddling", "Spooning", "Teasing", "Light tough", "Candles/aromas", "Discussing kinks/fantasies", "Massages", "Sleeping/napping together"], defaultRating),
...
["Assjobs", "Barebacking", "Breast/Chest Play", "Deep throat", "Docking", "Double barreling", "Double penetration", "Edging", "Fingering", "Fisting", "Footjobs", "Handjobs", "Hickies", "Instructions (JOI/SI)", "Nipple Play", "Oral Sex", "Anal sex", "Vaginal sex", "Rimming", "Titjobs"], defaultRating),
...
["Air-suction", "Anal beads", "Buttplugs", "Cock rings", "Dildos", "DIY", "Fuck machines", "External vibrators", "Insertable inflatables", "Insertable vibrators", "Kegel balls", "Magic wands", "Prostate massager", "Strap-ons"], defaultRating),
    createKinkCategory("Aftercare", ["General"], 
...
["Fire play", "Food play", "Forniphilia", "Breeding", "Pregnancy"], defaultRating),
]
